 ...
 *  slaveSelectPin: which pin is controlling the CS/SS pin of the first module?F
 */
void LedMatrix::init()
{
...
void LedMatrix::fixedWidth(int data)
{
    myFixedWidth = data;
}
...
void LedMatrix::setText(String text)
{
    ...
    for (int i = 0; i < myText.length(); i++)
        myTextLength += cp437_width[(byte)myText.charAt(i)];
    calculateTextAlignmentOffset();
}
